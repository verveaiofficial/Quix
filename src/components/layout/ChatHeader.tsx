...
.chat-hamburger span:nth-child(1) {
  width: 14px;
}

.chat-hamburger span:nth-child(2) {
  width: 10px;
}

.chat-hamburger span:nth-child(3) {
  width: 14px;
}
...
.status-badge.active .chevron-icon {
...
.hdr-dots-btn.active .dots-container span:nth-child(1) {
  left: 0px;
  top: 8px;
  width: 18px;
  height: 1.5px;
...
.hdr-dots-btn.active .dots-container span:nth-child(2) {
  opacity: 0;
  transform: scaleX(0);
}

.hdr-dots-btn.active .dots-container span:nth-child(3) {
  left: 0px;
  top: 8px;
  width: 18px;
  height: 1.5px;
...
#chat-options-menu {
  ...
  transition:
    ...
    visibility 0.18s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
...
export default function ChatHeader() {
  const { activeModel, setActiveModel, clearMessages } = useChatStore();
