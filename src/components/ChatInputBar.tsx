...
export const ChatInputBar: React.FC<ChatInputBarProps> = ({
  ...
  const spinDirRef = useRef<number>(1);
  ...
  return (
    <div className="input-wrapper" style={{ bottom: `${bottomOffset}px` }} onClick={(e) => e.stopPropagation()}>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        .plus-btn.spin-cw svg {
          animation: spinCW 0.75s cubic-bezier(0.25, 0, 0.2, 1) forwards;
        }
        .plus-btn.spin-ccw svg {
          animation: spinCCW 0.75s cubic-bezier(0.25, 0, 0.2, 1) forwards;
        }
      ...
      <input type="file" ref={imageInputRef} onChange={handleImageChange} accept="image/*" multiple style={{ display: 'none' }} />
